...
// Include the database connection file, which defines $server_ip
require 'dbh.php';

// Base URL for videos, using the server IP from dbh.php
$base_url = $server_ip . "uploads/";

// Select the latest videos
$sql = "SELECT `id`, `video_name`, `video_path`, `introduction`, `custom_file_name`, `upload_time` FROM `screenv4` ORDER BY `upload_time` DESC LIMIT 4";
